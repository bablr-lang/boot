...
export const dependencies = { CSTML, Regex };
...
export const covers = new Map([
  ...
  ['Attribute', new Set(['MappingAttribute', 'BooleanAttribute'])],
  ['AttributeValue', new Set(['CSTML:String', 'CSTML:Number'])],
  ['Matcher', new Set(['PropertyMatcher', 'CSTML:String', 'Regex:Pattern'])],
  [
    'NodeMatcher',
    new Set(['BasicNodeMatcher', 'GapNodeMatcher', 'ArrayNodeMatcher', 'NullNodeMatcher']),
  ],
  ['StringMatcher', new Set(['CSTML:String', 'Regex:Pattern'])],
]);
