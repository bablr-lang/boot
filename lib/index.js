import * as cstml from './languages/cstml.js';
...
export const str = buildTag(cstml, 'String');
export const num = buildTag(cstml, 'Integer');
export const cst = buildTag(cstml, 'Node');
